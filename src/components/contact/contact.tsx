...
export const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      grecaptcha.ready(async () => {
        const secret = '6Le5tEwqAAAAAFSZxZ_5mDP5yvtw7tPsPyOwAOlx';
        const token = await grecaptcha.execute(secret, { action: 'submit' });
  ...
  return (
    <>
      ...
      <Script src="https://www.google.com/recaptcha/api.js?render=6Le5tEwqAAAAAFSZxZ_5mDP5yvtw7tPsPyOwAOlx" />
    </>
  );
};
